...
<body>
    ...
    <header>
        <nav class="navbar">
            ...
            <ul class="nav-links">
                <li><a href="../index.html" class="<?php echo basename($_SERVER['PHP_SELF']) == 'index.html' ? 'active' : ''; ?>">Accueil</a></li>
                <li><a href="rooms.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'rooms.php' ? 'active' : ''; ?>">Chambres</a></li>
                <li><a href="reservations.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'reservations.php' ? 'active' : ''; ?>">Réservations</a></li>
